    ...
    public class Common
    {
        ...
        public static void SendSignMail(Entities.Borrow borrow)
        {
            ...
            string mailContent = $"Hello, {sign.User.CnName}\n" +
                                 ...
                                 $"Use for Model: {borrow.OModel.ModelName}\n" +
                                 $"Use for Station: {borrow.OStation.StationName}\n" +
                                 $"Note: {borrow.Note}\n" +
                                 $"\n" +
                                 $"Devices:\n";
            int i = 1;
            ...
            mailContent += "This is an automated email, so there is no need to reply. If you have any questions or require further assistance regarding this signature request, please contact our support team at <a href=\"javascript:;\">[cpeii-vn-te-me@mail.foxconn.com]</a> or  <a href=\"javascript:;\">[37145]</a>.\n";
            mailContent += "\n";
