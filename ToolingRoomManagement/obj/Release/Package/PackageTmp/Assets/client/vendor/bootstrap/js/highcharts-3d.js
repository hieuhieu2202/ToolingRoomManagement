...
*/
(function (a) { "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/highcharts-3d", ["highcharts"], function (B) { a(B); a.Highcharts = B; return a }) : a("undefined" !== typeof Highcharts ? Highcharts : void 0) })(function (a) {
    function B(a, l, u, d) { a.hasOwnProperty(l) || (a[l] = d.apply(null, u)) } a = a ? a._modules : {}; B(a, "Extensions/Math3D.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = l.pick, d = a.deg2rad, m = a.perspective3D = function (d,
        k, h) { k = 0 < h && h < Number.POSITIVE_INFINITY ? h / (d.z + k.z + h) : 1; return { x: d.x * k, y: d.y * k } }, w = a.perspective = function (k, a, h, r) {
            var b = a.options.chart.options3d, p = u(r, h ? a.inverted : !1), n = { x: a.plotWidth / 2, y: a.plotHeight / 2, z: b.depth / 2, vd: u(b.depth, 1) * u(b.viewDistance, 0) }, q = a.scale3d || 1; r = d * b.beta * (p ? -1 : 1); b = d * b.alpha * (p ? -1 : 1); var c = Math.cos(b), A = Math.cos(-r), v = Math.sin(b), e = Math.sin(-r); h || (n.x += a.plotLeft, n.y += a.plotTop); return k.map(function (b) {
                var d = (p ? b.y : b.x) - n.x; var h = (p ? b.x : b.y) - n.y; b = (b.z || 0) - n.z; d = {
                    x: A * d -
                    e * b, y: -v * e * d + c * h - A * v * b, z: c * e * d + v * h + c * A * b
                }; h = m(d, n, n.vd); h.x = h.x * q + n.x; h.y = h.y * q + n.y; h.z = d.z * q + n.z; return { x: p ? h.y : h.x, y: p ? h.x : h.y, z: h.z }
            })
        }; l = a.pointCameraDistance = function (d, k) { var h = k.options.chart.options3d, a = k.plotWidth / 2; k = k.plotHeight / 2; h = u(h.depth, 1) * u(h.viewDistance, 0) + h.depth; return Math.sqrt(Math.pow(a - u(d.plotX, d.x), 2) + Math.pow(k - u(d.plotY, d.y), 2) + Math.pow(h - u(d.plotZ, d.z), 2)) }; var k = a.shapeArea = function (d) {
            var k = 0, h; for (h = 0; h < d.length; h++) { var a = (h + 1) % d.length; k += d[h].x * d[a].y - d[a].x * d[h].y } return k /
            2
        ...
        function k(c, e, f, d, b, x, D, E) {
            var g = [], t = x - b; return x > b && x - b > Math.PI / 2 + .0001 ? (g = g.concat(k(c, e, f, d, b, b + Math.PI / 2, D, E)), g = g.concat(k(c,
            e, f, d, b + Math.PI / 2, x, D, E))) : x < b && b - x > Math.PI / 2 + .0001 ? (g = g.concat(k(c, e, f, d, b, b - Math.PI / 2, D, E)), g = g.concat(k(c, e, f, d, b - Math.PI / 2, x, D, E))) : [["C", c + f * Math.cos(b) - f * F * t * Math.sin(b) + D, e + d * Math.sin(b) + d * F * t * Math.cos(b) + E, c + f * Math.cos(x) + f * F * t * Math.sin(x) + D, e + d * Math.sin(x) - d * F * t * Math.cos(x) + E, c + f * Math.cos(x) + D, e + d * Math.sin(x) + E]]
        } var G = a.parse, p = u.perspective, h = u.shapeArea, r = w.animObject, b = w.defined, L = w.extend, n = w.merge, q = w.objectEach, c = w.pick, A = Math.cos, v = Math.PI, e = Math.sin, C = l.charts, M = l.deg2rad; var F =
        4 * (Math.sqrt(2) - 1) / 3 / (v / 2); m.prototype.toLinePath = function (c, d) { var f = []; c.forEach(function (c) { f.push(["L", c.x, c.y]) }); c.length && (f[0][0] = "M", d && f.push(["Z"])); return f }; m.prototype.toLineSegments = function (c) { var g = [], f = !0; c.forEach(function (c) { g.push(f ? ["M", c.x, c.y] : ["L", c.x, c.y]); f = !f }); return g }; m.prototype.face3d = function (g) {
            var e = this, f = this.createElement("path"); f.vertexes = []; f.insidePlotArea = !1; f.enabled = !0; f.attr = function (f) {
                if ("object" === typeof f && (b(f.enabled) || b(f.vertexes) || b(f.insidePlotArea))) {
                    this.enabled =
                    c(f.enabled, this.enabled); this.vertexes = c(f.vertexes, this.vertexes); this.insidePlotArea = c(f.insidePlotArea, this.insidePlotArea); delete f.enabled; delete f.vertexes; delete f.insidePlotArea; var g = p(this.vertexes, C[e.chartIndex], this.insidePlotArea), x = e.toLinePath(g, !0); g = h(g); g = this.enabled && 0 < g ? "visible" : "hidden"; f.d = x; f.visibility = g
            ...
            var g = this, f = this.g(), e = f.destroy; this.styledMode || f.attr({ "stroke-linejoin": "round" });
            f.faces = []; f.destroy = function () { for (var c = 0; c < f.faces.length; c++) f.faces[c].destroy(); return e.call(this) }; f.attr = function (c, e, D, E) { if ("object" === typeof c && b(c.faces)) { for (; f.faces.length > c.faces.length;) f.faces.pop().destroy(); for (; f.faces.length < c.faces.length;) f.faces.push(g.face3d().add(f)); for (var x = 0; x < c.faces.length; x++) g.styledMode && delete c.faces[x].fill, f.faces[x].attr(c.faces[x], null, D, E); delete c.faces } return d.prototype.attr.apply(this, arguments) }; f.animate = function (c, e, b) {
                if (c && c.faces) {
                    for (; f.faces.length >
                    c.faces.length;) f.faces.pop().destroy(); for (; f.faces.length < c.faces.length;) f.faces.push(g.face3d().add(f)); for (var x = 0; x < c.faces.length; x++) f.faces[x].animate(c.faces[x], e, b); delete c.faces
                } return d.prototype.animate.apply(this, arguments)
            }; return f.attr(c)
        }; a = {
            initArgs: function (c) {
                var g = this, f = g.renderer, e = f[g.pathType + "Path"](c), d = e.zIndexes; g.parts.forEach(function (c) { g[c] = f.path(e[c]).attr({ "class": "highcharts-3d-" + c, zIndex: d[c] || 0 }).add(g) }); g.attr({ "stroke-linejoin": "round", zIndex: d.group });
                g.originalDestroy = g.destroy; g.destroy = g.destroyParts; g.forcedSides = e.forcedSides
            }, singleSetterForParts: function (c, e, f, d, b, x) { var g = {}; d = [null, null, d || "attr", b, x]; var E = f && f.zIndexes; f ? (E && E.group && this.attr({ zIndex: E.group }), q(f, function (e, t) { g[t] = {}; g[t][c] = e; E && (g[t].zIndex = f.zIndexes[t] || 0) }), d[1] = g) : (g[c] = e, d[0] = g); return this.processParts.apply(this, d) }, processParts: function (g, e, f, d, b) { var x = this; x.parts.forEach(function (D) { e && (g = c(e[D], !1)); if (!1 !== g) x[D][f](g, d, b) }); return x }, destroyParts: function () {
                this.processParts(null,
                null, "destroy"); return this.originalDestroy()
            }
        }; var N = n(a, {
            parts: ["front", "top", "side"], pathType: "cuboid", attr: function (c, e, f, h) { if ("string" === typeof c && "undefined" !== typeof e) { var g = c; c = {}; c[g] = e } return c.shapeArgs || b(c.x) ? this.singleSetterForParts("d", null, this.renderer[this.pathType + "Path"](c.shapeArgs || c)) : d.prototype.attr.call(this, c, void 0, f, h) }, animate: function (c, e, f) {
                if (b(c.x) && b(c.y)) {
                    c = this.renderer[this.pathType + "Path"](c); var g = c.forcedSides; this.singleSetterForParts("d", null, c, "animate",
            ...
            }, fillSetter: function (c) { this.forcedSides = this.forcedSides || []; this.singleSetterForParts("fill", null, { front: c, top: G(c).brighten(0 <= this.forcedSides.indexOf("top") ? 0 : .1).get(), side: G(c).brighten(0 <= this.forcedSides.indexOf("side") ? 0 : -.1).get() }); this.color = this.fill = c; return this }
        }); m.prototype.elements3d = { base: a, cuboid: N }; m.prototype.element3d =
        function (c, e) { var f = this.g(); L(f, this.elements3d[c]); f.initArgs(e); return f }; m.prototype.cuboid = function (c) { return this.element3d("cuboid", c) }; m.prototype.cuboidPath = function (c) {
            function e(c) { return 0 === D && 1 < c && 6 > c ? { x: a[c].x, y: a[c].y + 10, z: a[c].z } : a[0].x === a[7].x && 4 <= c ? { x: a[c].x + 10, y: a[c].y, z: a[c].z } : 0 === v && 2 > c || 5 < c ? { x: a[c].x, y: a[c].y, z: a[c].z + 10 } : a[c] } function f(c) { return a[c] } var g = c.x, d = c.y, b = c.z || 0, D = c.height, E = c.width, v = c.depth, t = C[this.chartIndex], y = t.options.chart.options3d.alpha, A = 0, a = [{
                x: g,
                y: d, z: b
            }, { x: g + E, y: d, z: b }, { x: g + E, y: d + D, z: b }, { x: g, y: d + D, z: b }, { x: g, y: d + D, z: b + v }, { x: g + E, y: d + D, z: b + v }, { x: g + E, y: d, z: b + v }, { x: g, y: d, z: b + v }], q = []; a = p(a, t, c.insidePlotArea); var z = function (c, t, g) { var d = [[], -1], b = c.map(f), y = t.map(f); c = c.map(e); t = t.map(e); 0 > h(b) ? d = [b, 0] : 0 > h(y) ? d = [y, 1] : g && (q.push(g), d = 0 > h(c) ? [b, 0] : 0 > h(t) ? [y, 1] : [b, 0]); return d }; var k = z([3, 2, 1, 0], [7, 6, 5, 4], "front"); c = k[0]; var n = k[1]; k = z([1, 6, 7, 0], [4, 5, 2, 3], "top"); E = k[0]; var r = k[1]; k = z([1, 2, 5, 6], [0, 7, 4, 3], "side"); z = k[0]; k = k[1]; 1 === k ? A += 1E6 * (t.plotWidth -
            g) : k || (A += 1E6 * g); A += 10 * (!r || 0 <= y && 180 >= y || 360 > y && 357.5 < y ? t.plotHeight - d : 10 + d); 1 === n ? A += 100 * b : n || (A += 100 * (1E3 - b)); return { front: this.toLinePath(c, !0), top: this.toLinePath(E, !0), side: this.toLinePath(z, !0), zIndexes: { group: Math.round(A) }, forcedSides: q, isFront: n, isTop: r }
        }; m.prototype.arc3d = function (e) {
            function b(c) { var f = !1, e = {}, d; c = n(c); for (d in c) -1 !== a.indexOf(d) && (e[d] = c[d], delete c[d], f = !0); return f ? [e, c] : !1 } var f = this.g(), g = f.renderer, a = "x y r innerR start end depth".split(" "); e = n(e); e.alpha = (e.alpha ||
            0) * M; e.beta = (e.beta || 0) * M; f.top = g.path(); f.side1 = g.path(); f.side2 = g.path(); f.inn = g.path(); f.out = g.path(); f.onAdd = function () { var c = f.parentGroup, e = f.attr("class"); f.top.add(f);["out", "inn", "side1", "side2"].forEach(function (d) { f[d].attr({ "class": e + " highcharts-3d-side" }).add(c) }) };["addClass", "removeClass"].forEach(function (c) { f[c] = function () { var e = arguments;["top", "out", "inn", "side1", "side2"].forEach(function (d) { f[d][c].apply(f[d], e) }) } }); f.setPaths = function (c) {
                var e = f.renderer.arc3dPath(c), d = 100 *
                ...
                var e = G(c).brighten(-.1).get(); this.fill = c; this.side1.attr({ fill: e }); this.side2.attr({ fill: e }); this.inn.attr({ fill: e }); this.out.attr({ fill: e }); this.top.attr({ fill: c });
                return this
                ...
                var v = this.attribs, t = "data-" + Math.random().toString(26).substring(2, 9); delete e.center; delete e.z; delete e.alpha;
            ...
            function d(c) { c %= 2 * Math.PI; c > Math.PI && (c = 2 * Math.PI - c); return c } var f = c.x, b = c.y, g = c.start, a = c.end - .00001, h = c.r, q = c.innerR || 0, n = c.depth || 0, t = c.alpha, y = c.beta, J = Math.cos(g), K = Math.sin(g); c = Math.cos(a); var I = Math.sin(a),
            ...
            C * Math.sin(a) + r]); y = y.concat(k(f, b, H, C, a, g, q, r)); y.push(["Z"]); J = [["M", f + z * J, b + h * K], ["L", f + z * J + q, b + h * K + r], ["L", f + H * J + q, b + C * K + r], ["L", f + H * J, b + C * K], ["Z"]]; f = [["M", f + z * c, b + h * I], ["L", f + z * c + q, b + h * I + r], ["L", f + H * c + q, b + C * I + r], ["L", f + H * c, b + C * I], ["Z"]]; I = Math.atan2(r, -q); b = Math.abs(a + I); c = Math.abs(g + I); g = Math.abs((g + a) / 2 + I); b = d(b); c = d(c); g = d(g); g *= 1E5; a = 1E5 * c; b *= 1E5; return { top: n, zTop: 1E5 * Math.PI + 1, out: t, zOut: Math.max(g, a, b), inn: y, zInn: Math.max(g, a, b), side1: J, zSide1: .99 * b, side2: f, zSide2: .99 * a }
        }
    }); B(a, "Core/Axis/Tick3D.js",
    [a["Core/Utilities.js"]], function (a) {
        var l = a.addEvent, u = a.extend, d = a.wrap; return function () {
            function a() { } a.compose = function (m) { l(m, "afterGetLabelPosition", a.onAfterGetLabelPosition); d(m.prototype, "getMarkPath", a.wrapGetMarkPath) }; a.onAfterGetLabelPosition = function (d) { var a = this.axis.axis3D; a && u(d.pos, a.fix3dPosition(d.pos)) }; a.wrapGetMarkPath = function (d) {
                var a = this.axis.axis3D, m = d.apply(this, [].slice.call(arguments, 1)); if (a) {
                    var p = m[0], h = m[1]; if ("M" === p[0] && "L" === h[0]) return a = [a.fix3dPosition({
                        x: p[1],
                        y: p[2], z: 0
        ...
        var w = l.perspective, k = l.perspective3D, G = l.shapeArea, p = m.addEvent, h = m.merge, r = m.pick, b = m.wrap, L = a.deg2rad, n = function () {
            ...
            }; b.prototype.swapZ = function (c, d) { var b = this.axis; return b.isZAxis ? (d = d ? 0 : b.chart.plotLeft, { x: d + c.z, y: c.y, z: c.x - d }) : c }; return b
        }(); return function () {
            function a() { } a.compose = function (c) {
            ...
            }; a.onAfterSetOptions = function () { var c = this.chart, d = this.options; c.is3d && c.is3d() && "colorAxis" !== this.coll && (d.tickWidth = r(d.tickWidth, 0), d.gridLineWidth = r(d.gridLineWidth, 1)) }; a.onDestroy = function () {
                ["backFrame", "bottomFrame",
                "sideFrame"].forEach(function (c) { this[c] && (this[c] = this[c].destroy()) }, this)
            }; a.onDrawCrosshair = function (c) { this.chart.is3d() && "colorAxis" !== this.coll && c.point && (c.point.crosshairPos = this.isXAxis ? c.point.axisXpos : this.len - c.point.axisYpos) }; a.onInit = function () { this.axis3D || (this.axis3D = new n(this)) }; a.wrapGetLinePath = function (c) { return this.chart.is3d() && "colorAxis" !== this.coll ? [] : c.apply(this, [].slice.call(arguments, 1)) }; a.wrapGetPlotBandPath = function (c) {
                if (!this.chart.is3d() || "colorAxis" === this.coll) return c.apply(this,
                [].slice.call(arguments, 1)); var d = arguments, a = d[2], e = []; d = this.getPlotLinePath({ value: d[1] }); a = this.getPlotLinePath({ value: a }); if (d && a) for (var b = 0; b < d.length; b += 2) { var h = d[b], k = d[b + 1], n = a[b], g = a[b + 1]; "M" === h[0] && "L" === k[0] && "M" === n[0] && "L" === g[0] && e.push(h, k, g, ["L", n[1], n[2]], ["Z"]) } return e
            }; a.wrapGetPlotLinePath = function (c) {
                var d = this.axis3D, a = this.chart, e = c.apply(this, [].slice.call(arguments, 1)); if ("colorAxis" === this.coll || !a.chart3d || !a.is3d() || null === e) return e; var b = a.options.chart.options3d,
                ...
                var b = this.chart, a = this.ticks, h = this.gridGroup; if (this.categories && b.frameShapes && b.is3d() && h && d && d.label) {
                    h = h.element.childNodes[0].getBBox(); var n = b.frameShapes.left.getBBox(), q = b.options.chart.options3d; b = { x: b.plotWidth / 2, y: b.plotHeight / 2, z: q.depth / 2, vd: r(q.depth, 1) * r(q.viewDistance, 0) }; var p, g; q = d.pos; var m = a[q - 1]; a =
                    a[q + 1]; 0 !== q && m && m.label.xy && (p = k({ x: m.label.xy.x, y: m.label.xy.y, z: null }, b, b.vd)); a && a.label.xy && (g = k({ x: a.label.xy.x, y: a.label.xy.y, z: null }, b, b.vd)); a = { x: d.label.xy.x, y: d.label.xy.y, z: null }; a = k(a, b, b.vd); return Math.abs(p ? a.x - p.x : g ? g.x - a.x : h.x - n.x)
                } return c.apply(this, [].slice.call(arguments, 1))
            }; a.wrapGetTitlePosition = function (c) { var d = c.apply(this, [].slice.call(arguments, 1)); return this.axis3D ? this.axis3D.fix3dPosition(d, !0) : d }; a.defaultOptions = {
                labels: { position3d: "offset", skew3d: !1 }, title: {
                    position3d: null,
                    skew3d: null
                }
            }; return a
    ...
    a["Core/Options.js"], a["Core/Utilities.js"], a["Core/Axis/ZAxis.js"]], function (a, l, u, d, m, w, k, G) {
        var p = m.perspective, h = m.shapeArea3D, r = w.defaultOptions, b = k.addEvent; m = k.Fx; var B = k.isArray, n = k.merge, q = k.pick, c = k.wrap, A; (function (a) {
            function e(c) { this.is3d() && "scatter" === c.options.type && (c.options.type = "scatter3d") } function k() {
                if (this.chart3d && this.is3d()) {
                    var c = this.renderer, a = this.options.chart.options3d, b = this.chart3d.get3dFrame(), e = this.plotLeft, f = this.plotLeft + this.plotWidth, g = this.plotTop, h = this.plotTop +
                    ...
                    this.frameShapes.bottom[v]({
                        "class": "highcharts-3d-frame highcharts-3d-frame-bottom", zIndex: b.bottom.frontFacing ? -1E3 : 1E3, faces: [{ fill: d.color(b.bottom.color).brighten(.1).get(), vertexes: [{ x: k, y: m, z: p }, { x: q, y: m, z: p }, { x: q, y: m, z: l }, { x: k, y: m, z: l }], enabled: b.bottom.visible }, { fill: d.color(b.bottom.color).brighten(.1).get(), vertexes: [{ x: e, y: h, z: a }, { x: f, y: h, z: a }, { x: f, y: h, z: 0 }, { x: e, y: h, z: 0 }], enabled: b.bottom.visible }, {
                            fill: d.color(b.bottom.color).brighten(-.1).get(), vertexes: [{ x: k, y: m, z: p }, { x: k, y: m, z: l },
                            { x: e, y: h, z: a }, { x: e, y: h, z: 0 }], enabled: b.bottom.visible && !b.left.visible
                        }, { fill: d.color(b.bottom.color).brighten(-.1).get(), vertexes: [{ x: q, y: m, z: l }, { x: q, y: m, z: p }, { x: f, y: h, z: 0 }, { x: f, y: h, z: a }], enabled: b.bottom.visible && !b.right.visible }, { fill: d.color(b.bottom.color).get(), vertexes: [{ x: q, y: m, z: p }, { x: k, y: m, z: p }, { x: e, y: h, z: 0 }, { x: f, y: h, z: 0 }], enabled: b.bottom.visible && !b.front.visible }, {
                            fill: d.color(b.bottom.color).get(), vertexes: [{ x: k, y: m, z: l }, { x: q, y: m, z: l }, { x: f, y: h, z: a }, { x: e, y: h, z: a }], enabled: b.bottom.visible &&
                            !b.back.visible
                        }]
                    }); this.frameShapes.top[v]({
                        "class": "highcharts-3d-frame highcharts-3d-frame-top", zIndex: b.top.frontFacing ? -1E3 : 1E3, faces: [{ fill: d.color(b.top.color).brighten(.1).get(), vertexes: [{ x: k, y: n, z: l }, { x: q, y: n, z: l }, { x: q, y: n, z: p }, { x: k, y: n, z: p }], enabled: b.top.visible }, { fill: d.color(b.top.color).brighten(.1).get(), vertexes: [{ x: e, y: g, z: 0 }, { x: f, y: g, z: 0 }, { x: f, y: g, z: a }, { x: e, y: g, z: a }], enabled: b.top.visible }, {
                            fill: d.color(b.top.color).brighten(-.1).get(), vertexes: [{ x: k, y: n, z: l }, { x: k, y: n, z: p }, {
                                x: e,
                                y: g, z: 0
                            }, { x: e, y: g, z: a }], enabled: b.top.visible && !b.left.visible
                    ...
                    this.frameShapes.left[v]({
                        ...
                        "class": "highcharts-3d-frame highcharts-3d-frame-back", zIndex: b.back.frontFacing ? -1E3 : 1E3, faces: [{
                            ...
                            vertexes: [{ x: q, y: m, z: l }, { x: k, y: m, z: l }, { x: e, y: h, z: a }, { x: f, y: h, z: a }], enabled: b.back.visible && !b.bottom.visible
                        }, { fill: d.color(b.back.color).brighten(.1).get(), vertexes: [{ x: k, y: n, z: l }, { x: q, y: n, z: l }, { x: f, y: g, z: a }, { x: e, y: g, z: a }], enabled: b.back.visible && !b.top.visible }, { fill: d.color(b.back.color).brighten(-.1).get(), vertexes: [{ x: k, y: m, z: l }, { x: k, y: n, z: l }, { x: e, y: g, z: a }, { x: e, y: h, z: a }], enabled: b.back.visible && !b.left.visible }, {
                            fill: d.color(b.back.color).brighten(-.1).get(), vertexes: [{ x: q, y: n, z: l }, {
                                x: q, y: m,
                                z: l
                            }, { x: f, y: h, z: a }, { x: f, y: g, z: a }], enabled: b.back.visible && !b.right.visible
                        ...
                        "class": "highcharts-3d-frame highcharts-3d-frame-front", zIndex: b.front.frontFacing ? -1E3 : 1E3, faces: [{
                            ...
                            vertexes: [{ x: k, y: m, z: p }, { x: q, y: m, z: p }, { x: f, y: h, z: 0 }, { x: e, y: h, z: 0 }], enabled: b.front.visible && !b.bottom.visible
                        }, { fill: d.color(b.front.color).brighten(.1).get(), vertexes: [{ x: q, y: n, z: p }, { x: k, y: n, z: p }, { x: e, y: g, z: 0 }, { x: f, y: g, z: 0 }], enabled: b.front.visible && !b.top.visible }, { fill: d.color(b.front.color).brighten(-.1).get(), vertexes: [{ x: k, y: n, z: p }, { x: k, y: m, z: p }, { x: e, y: h, z: 0 }, { x: e, y: g, z: 0 }], enabled: b.front.visible && !b.left.visible }, {
                            fill: d.color(b.front.color).brighten(-.1).get(), vertexes: [{ x: q, y: m, z: p }, {
                                x: q,
                                y: n, z: p
                            }, { x: f, y: g, z: 0 }, { x: f, y: h, z: 0 }], enabled: b.front.visible && !b.right.visible
                ...
                [{ name: "darker", slope: .6 }, { name: "brighter", slope: 1.4 }].forEach(function (c) { this.renderer.definition({ tagName: "filter", id: "highcharts-" + c.name, children: [{ tagName: "feComponentTransfer", children: [{ tagName: "feFuncR", type: "linear", slope: c.slope }, { tagName: "feFuncG", type: "linear", slope: c.slope }, { tagName: "feFuncB", type: "linear", slope: c.slope }] }] }) }, this))
            } function l() {
                var c = this.options; this.is3d() && (c.series || []).forEach(function (b) {
                    "scatter" === (b.type || c.chart.type || c.chart.defaultSeriesType) && (b.type =
                    "scatter3d")
                })
            } function v() { var c = this.options.chart.options3d; if (this.chart3d && this.is3d()) { c && (c.alpha = c.alpha % 360 + (0 <= c.alpha ? 0 : 360), c.beta = c.beta % 360 + (0 <= c.beta ? 0 : 360)); var b = this.inverted, a = this.clipBox, d = this.margin; a[b ? "y" : "x"] = -(d[3] || 0); a[b ? "x" : "y"] = -(d[0] || 0); a[b ? "height" : "width"] = this.chartWidth + (d[3] || 0) + (d[1] || 0); a[b ? "width" : "height"] = this.chartHeight + (d[0] || 0) + (d[2] || 0); this.scale3d = 1; !0 === c.fitToPlot && (this.scale3d = this.chart3d.getScale(c.depth)); this.chart3d.frame3d = this.chart3d.get3dFrame() } }
            ...
            var D = function () {
                function c(c) { this.frame3d = void 0; this.chart = c } c.prototype.get3dFrame = function () {
                    var c = this.chart, b = c.options.chart.options3d, a = b.frame, d = c.plotLeft, e = c.plotLeft + c.plotWidth, f = c.plotTop, g = c.plotTop + c.plotHeight, k = b.depth, n = function (a) { a = h(a, c); return .5 < a ? 1 : -.5 > a ? -1 : 0 }, m = n([{ x: d, y: g, z: k }, { x: e, y: g, z: k }, { x: e, y: g, z: 0 }, { x: d, y: g, z: 0 }]), l = n([{ x: d, y: f, z: 0 }, { x: e, y: f, z: 0 }, { x: e, y: f, z: k }, { x: d, y: f, z: k }]), v = n([{ x: d, y: f, z: 0 }, { x: d, y: f, z: k }, { x: d, y: g, z: k }, { x: d, y: g, z: 0 }]), r = n([{ x: e, y: f, z: k }, {
                        x: e, y: f,
                        z: 0
                    }, { x: e, y: g, z: 0 }, { x: e, y: g, z: k }]), A = n([{ x: d, y: g, z: 0 }, { x: e, y: g, z: 0 }, { x: e, y: f, z: 0 }, { x: d, y: f, z: 0 }]); n = n([{ x: d, y: f, z: k }, { x: e, y: f, z: k }, { x: e, y: g, z: k }, { x: d, y: g, z: k }]); var u = !1, F = !1, w = !1, G = !1;[].concat(c.xAxis, c.yAxis, c.zAxis).forEach(function (c) { c && (c.horiz ? c.opposite ? F = !0 : u = !0 : c.opposite ? G = !0 : w = !0) }); var C = function (c, a, b) {
                        for (var d = ["size", "color", "visible"], e = {}, f = 0; f < d.length; f++) for (var g = d[f], h = 0; h < c.length; h++) if ("object" === typeof c[h]) { var k = c[h][g]; if ("undefined" !== typeof k && null !== k) { e[g] = k; break } } c =
                        b; !0 === e.visible || !1 === e.visible ? c = e.visible : "auto" === e.visible && (c = 0 < a); return { size: q(e.size, 1), color: q(e.color, "none"), frontFacing: 0 < a, visible: c }
                    }; a = { axes: {}, bottom: C([a.bottom, a.top, a], m, u), top: C([a.top, a.bottom, a], l, F), left: C([a.left, a.right, a.side, a], v, w), right: C([a.right, a.left, a.side, a], r, G), back: C([a.back, a.front, a], n, !0), front: C([a.front, a.back, a], A, !1) }; "auto" === b.axisLabelPosition ? (r = function (c, a) { return c.visible !== a.visible || c.visible && a.visible && c.frontFacing !== a.frontFacing }, b = [], r(a.left,
                    ...
                    var a = this.chart, b = a.plotLeft, d = a.plotWidth + b, e = a.plotTop, f = a.plotHeight +
                    ...
                    e + h)) : Math.min(l, 1 - (e + h) / (q + h) % 1)); f < m && (l = Math.min(l, Math.abs((f - h) / (m - h)))); return l
                }; return c
                ...
                var p = h.prototype; q = q.prototype; p.is3d = function () { return this.options.chart.options3d && this.options.chart.options3d.enabled }; p.propsRequireDirtyBox.push("chart.options3d");
        ...
        var d = l.perspective; l = u.addEvent; var m = u.pick; l(a.Series, "afterTranslate", function () { this.chart.is3d() && this.translate3dPoints() }); a.Series.prototype.translate3dPoints = function () {
            var a = this.chart, k = m(this.zAxis,
            a.options.zAxis[0]), l = [], p; for (p = 0; p < this.data.length; p++) { var h = this.data[p]; if (k && k.translate) { var r = k.logarithmic && k.val2lin ? k.val2lin(h.z) : h.z; h.plotZ = k.translate(r); h.isInside = h.isInside ? r >= k.min && r <= k.max : !1 } else h.plotZ = 0; h.axisXpos = h.plotX; h.axisYpos = h.plotY; h.axisZpos = h.plotZ; l.push({ x: h.plotX, y: h.plotY, z: h.plotZ }) } a = d(l, a, !0); for (p = 0; p < this.data.length; p++) h = this.data[p], k = a[p], h.plotX = k.x, h.plotY = k.y, h.plotZ = k.z
        }
    ...
    a["Extensions/Stacking.js"], a["Core/Utilities.js"]], function (a, l, u, d) {
        ...
        d(r.prototype, "justifyDataLabel", function (a) { return arguments[2].outside3dPlot ? !1 : a.apply(this, [].slice.call(arguments, 1)) }); b.column.prototype.translate3dPoints = function () { }; b.column.prototype.translate3dShapes = function () {
            var a = this, b = a.chart, c = a.options, d = c.depth, h = (c.stacking ? c.stack || 0 : a.index) * (d + (c.groupZPadding || 1)), e = a.borderWidth % 2 ? .5 : 0, k; b.inverted && !a.yAxis.reversed && (e *= -1); !1 !== c.grouping && (h = 0); h += c.groupZPadding || 1; a.data.forEach(function (c) {
            ...
            if (this.chart.is3d()) {
                var b = arguments[1], c = this.yAxis, d = this, h = this.yAxis.reversed; B && (b ? d.data.forEach(function (a) { null !== a.y && (a.height = a.shapeArgs.height, a.shapey = a.shapeArgs.y, a.shapeArgs.height = 1, h || (a.shapeArgs.y = a.stackY ? a.plotY + c.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height))) }) : (d.data.forEach(function (a) {
            ...
            "dataLabelsGroup" !== b && this.chart.is3d() && (this[b] && delete this[b], e && (this.chart.columnGroup || (this.chart.columnGroup = this.chart.renderer.g("columnGroup").add(e)), this[b] = this.chart.columnGroup, this.chart.columnGroup.attr(this.getPlotBox()), this[b].survive = !0, "group" === b || "markerGroup" === b)) && (arguments[3] =
            "visible"); return a.apply(this, Array.prototype.slice.call(arguments, 1))
        }); d(b.column.prototype, "setVisible", function (a, b) { var c = this, d; c.chart.is3d() && c.data.forEach(function (a) { d = (a.visible = a.options.visible = b = "undefined" === typeof b ? !h(c.visible, a.visible) : b) ? "visible" : "hidden"; c.options.data[c.data.indexOf(a)] = a.options; a.graphic && a.graphic.attr({ visibility: d }) }); a.apply(this, Array.prototype.slice.call(arguments, 1)) }); b.column.prototype.handle3dGrouping = !0; l(r, "afterInit", function () {
            if (this.chart.is3d() &&
        ...
        G); b.columnrange && (d(b.columnrange.prototype, "pointAttribs", w), d(b.columnrange.prototype, "setState", k), d(b.columnrange.prototype.pointClass.prototype, "hasNewShapeType", G), b.columnrange.prototype.plotGroup = b.column.prototype.plotGroup, b.columnrange.prototype.setVisible = b.column.prototype.setVisible); d(r.prototype, "alignDataLabel", function (a, b, c, d, k) {
            var e = this.chart; d.outside3dPlot = b.outside3dPlot; if (e.is3d() && this.is("column")) {
                var l = this.options, m = h(d.inside, !!this.options.stacking), n = e.options.chart.options3d,
                q = b.pointWidth / 2 || 0; l = { x: k.x + q, y: k.y, z: this.z + l.depth / 2 }; e.inverted && (m && (k.width = 0, l.x += b.shapeArgs.height / 2), 90 <= n.alpha && 270 >= n.alpha && (l.y += b.shapeArgs.width)); l = p([l], e, !0, !1)[0]; k.x = l.x - q; k.y = b.outside3dPlot ? -9E9 : l.y
            } a.apply(this, [].slice.call(arguments, 1))
        }); d(u.prototype, "getStackBox", function (a, d, c, h, k, e, l, m) {
            var n = a.apply(this, [].slice.call(arguments, 1)); if (d.is3d() && c.base) {
                var q = +c.base.split(",")[0], g = d.series[q]; q = d.options.chart.options3d; g && g instanceof b.column && (g = {
                    x: n.x + (d.inverted ?
                        l : e / 2), y: n.y, z: g.options.depth / 2
                }, d.inverted && (n.width = 0, 90 <= q.alpha && 270 >= q.alpha && (g.y += e)), g = p([g], d, !0, !1)[0], n.x = g.x - e / 2, n.y = g.y)
            } return n
        })
    }); B(a, "Series/Pie3DSeries.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, l) {
        var u = l.pick; l = l.wrap; var d = a.deg2rad, m = a.seriesTypes, w = a.svg; l(m.pie.prototype, "translate", function (a) {
            a.apply(this, [].slice.call(arguments, 1)); if (this.chart.is3d()) {
                var k = this, l = k.options, h = l.depth || 0, m = k.chart.options.chart.options3d, b = m.alpha, u = m.beta, n = l.stacking ?
        ...
        }); l(m.pie.prototype.pointClass.prototype, "haloPath", function (a) { var d = arguments; return this.series.chart.is3d() ? [] : a.call(this, d[1]) }); l(m.pie.prototype, "pointAttribs",
        function (a, d, l) { a = a.call(this, d, l); l = this.options; this.chart.is3d() && !this.chart.styledMode && (a.stroke = l.edgeColor || d.color || this.color, a["stroke-width"] = u(l.edgeWidth, 1)); return a }); l(m.pie.prototype, "drawDataLabels", function (a) {
            if (this.chart.is3d()) {
                var k = this.chart.options.chart.options3d; this.data.forEach(function (a) {
                    var h = a.shapeArgs, l = h.r, b = (h.start + h.end) / 2; a = a.labelPosition; var m = a.connectorPosition, n = -l * (1 - Math.cos((h.alpha || k.alpha) * d)) * Math.sin(b), p = l * (Math.cos((h.beta || k.beta) * d) - 1) * Math.cos(b);
            ...
            if (this.chart.is3d()) {
                var d = arguments[1], k = this.options.animation, h = this.center, l = this.group, b = this.markerGroup; w && (!0 === k && (k = {}), d ? (l.oldtranslateX = u(l.oldtranslateX, l.translateX), l.oldtranslateY = u(l.oldtranslateY,
                l.translateY), d = { translateX: h[0], translateY: h[1], scaleX: .001, scaleY: .001 }, l.attr(d), b && (b.attrSetters = l.attrSetters, b.attr(d))) : (d = { translateX: l.oldtranslateX, translateY: l.oldtranslateY, scaleX: 1, scaleY: 1 }, l.animate(d, k), b && b.animate(d, k)))
            } else a.apply(this, [].slice.call(arguments, 1))
        })
        ...
        var m = l.pointCameraDistance; l = d.seriesType; var w = a.seriesTypes;
        ...
        var l = a.addEvent, u = function () { return function (a) { this.axis = a } }(); return function () {
            function a() { } a.compose = function (d) { d.keepProps.push("vml"); l(d, "init", a.onInit); l(d, "render", a.onRender) }; a.onInit = function () { this.vml || (this.vml = new u(this)) }; a.onRender = function () {
                var a = this.vml; a.sideFrame && (a.sideFrame.css({ zIndex: 0 }), a.sideFrame.front.attr({ fill: a.sideFrame.color })); a.bottomFrame && (a.bottomFrame.css({ zIndex: 1 }), a.bottomFrame.front.attr({ fill: a.bottomFrame.color }));
        ...
        d = d.setOptions; var w = l.VMLRenderer; w && (d({ animate: !1 }), w.prototype.face3d = u.prototype.face3d, w.prototype.polyhedron = u.prototype.polyhedron, w.prototype.elements3d = u.prototype.elements3d, w.prototype.element3d =
